...
// 导出组件
export { Button, ButtonFold, Copy, CountUpNumber, CurrencyInput, DateRangeConfirmPicker, Icon }
...
const components = [Button, ButtonFold, Copy, CountUpNumber, CurrencyInput, DateRangeConfirmPicker, Icon]
